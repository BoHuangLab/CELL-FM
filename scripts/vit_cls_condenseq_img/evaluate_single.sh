...
[ -z "${output_dir}" ] && output_dir=output/condenseq/vit_cls_img/eval_single
...
python -m torch.distributed.run $DISTRIBUTED_ARGS cell_fm/tasks/vit_cls_condenseq_img/evaluate_single.py \
