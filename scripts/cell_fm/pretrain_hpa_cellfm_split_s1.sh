...
# Training
[ -z "${vae_loadcheck_path}" ] && vae_loadcheck_path=/hpc/projects/group.huang/dihan.zheng/CELL-FM/pretrain_hpa/PT_VAE_HPA_KL1e-4_S256/checkpoint-50000/pytorch_model.bin
