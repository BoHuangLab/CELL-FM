...
# Wandb
export WANDB_RUN_NAME=PT_HPA_CELLFM_Dev_NH8_S2_R1
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa_cellfm_split/PT_HPA_CELLFM_Dev_NH8_S1_R1/checkpoint-50000/pytorch_model.bin
...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=50489
