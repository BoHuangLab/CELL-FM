...
[ -z "${output_dir}" ] && output_dir=./output/opencell_cytoself/embedding/
...
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell_cytoself/FT_OC-Cytoself_CELLFM_S1_R2/checkpoint-100000

# Evaluation
[ -z "${num_steps}" ] && num_steps=100


python cell_fm/tasks/cell_fm/embed_opencell_cytoself.py \
