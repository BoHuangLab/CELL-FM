...
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell/FT_OC_CELLFM_padseq_wd1e-2_all_S2_R1/checkpoint-65000

# Evaluation
[ -z "${num_steps}" ] && num_steps=100


python cell_fm/tasks/cell_fm/pls_screening_opencell.py \
