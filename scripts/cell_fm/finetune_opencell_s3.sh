...
# Wandb
export WANDB_RUN_NAME=FT_OC_CELLFM_padseq_wd1e-2_all_S3_R1
...
# Training
[ -z "${vae_loadcheck_path}" ] && vae_loadcheck_path=/hpc/projects/group.huang/dihan.zheng/CELL-Diff2/finetune_opencell/FT_VAE_OC_Crop256_KL1e-4_FP32/checkpoint-50000/pytorch_model.bin
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell/FT_OC_CELLFM_all_S1_R1/checkpoint-100000
...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=18291
