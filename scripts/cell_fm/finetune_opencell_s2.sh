...
# Wandb
export WANDB_RUN_NAME=FT_OC_CELLFM_Dev_NH8_clip_all_S2_R1
...
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell/FT_OC_CELLFM_Dev_NH8_clip_all_S1_R1/checkpoint-100000/pytorch_model.bin
