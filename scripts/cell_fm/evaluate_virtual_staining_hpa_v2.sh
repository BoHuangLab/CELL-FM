...
[ -z "${split_key}" ] && split_key=virtual_staining
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa/cellfm_img2seq/checkpoint-60000/pytorch_model.bin

# Evaluation
[ -z "${num_steps}" ] && num_steps=100


python cell_fm/tasks/cell_fm/virtual_staining_hpa.py \
