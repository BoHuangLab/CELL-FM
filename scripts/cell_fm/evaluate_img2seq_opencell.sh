...
[ -z "${output_dir}" ] && output_dir=./output/opencell/nls_generation/cell_fm
# [ -z "${output_dir}" ] && output_dir=./output/opencell/nes_generation/cell_fm
# [ -z "${output_dir}" ] && output_dir=./output/opencell/nols_generation/cell_fm
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa/PT_HPA_CELLFM_Dev_NH8_all_S1_R1/checkpoint-5000/pytorch_model.bin

# Evaluation
[ -z "${num_steps}" ] && num_steps=100


python cell_fm/tasks/cell_fm/pls_generation_opencell.py \
