...
[ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/human_protein_atlas/seq2img/cellfm_test_nucl_prot/

# Dataset
[ -z "${data_path}" ] && data_path='/hpc/reference/opencell/human_protein_atlas'
[ -z "${split_key}" ] && split_key=cellfm_test_nucl_prot
...
python cell_fm/tasks/cell_fm/virtual_staining_hpa_nucl_prot.py \
