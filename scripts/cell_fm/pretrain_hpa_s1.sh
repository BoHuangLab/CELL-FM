...
# Wandb
export WANDB_RUN_NAME=PT_HPA_CELLFM_Dev_NH8_all_S1_R11
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa/PT_HPA_CELLFM_Dev_NH8_all_S1_R10/checkpoint-40000/pytorch_model.bin
...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=29924
