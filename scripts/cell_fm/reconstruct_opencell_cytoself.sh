...
[ -z "${output_dir}" ] && output_dir=./output/opencell_cytoself/reconstruct/
...
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell_cytoself/FT_OC-Cytoself_CELLFM_Dev_NH8_S1_R1/checkpoint-10000/pytorch_model.bin


python cell_fm/tasks/cell_fm/reconstruct_opencell_cytoself.py \
