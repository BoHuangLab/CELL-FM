...
# Wandb
[ -z "${output_dir}" ] && output_dir=./output/opencell/pls_screening

# Dataset
[ -z "${data_path}" ] && data_path=/home/dihan.zheng/workspace/dihan.zheng/dataset/opencell/lmdb_dataset
...
[ -z "${split_key}" ] && split_key=nes_generation
...
# Training
[ -z "${vae_loadcheck_path}" ] && vae_loadcheck_path=/hpc/projects/group.huang/dihan.zheng/stable_diffusion_text2img/finetune_opencell/FT_VAE_OC_CELL-E2-split/checkpoint-20000/pytorch_model.bin
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell/FT_CELL-Diff-V4_R7-3-2_BOC320-1280_MNAH8_NHL8_DPS1_ZM0d5/checkpoint-28000
# [ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell/FT_CELL-Diff-V4_R7-3-4_BOC320-1280_MNAH8_NHL8_DPS1_ZM0d5/checkpoint-50000
...
python cell_fm/tasks/cell_fm/nls_opencell.py \
