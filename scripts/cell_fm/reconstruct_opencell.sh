...
[ -z "${output_dir}" ] && output_dir=./output/opencell/reconstruct/
...
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell/FT_OC_CELLFM_Crop256_S1_R1_all/checkpoint-100000

# Evaluation
[ -z "${num_steps}" ] && num_steps=100


python cell_fm/tasks/cell_fm/reconstruct_opencell.py \
