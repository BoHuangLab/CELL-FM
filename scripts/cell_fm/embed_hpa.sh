...
[ -z "${output_dir}" ] && output_dir=./output/hpa/embedding/PT_HPA_CELLFM_Dev_NH8_no_mae/
# [ -z "${output_dir}" ] && output_dir=./output/hpa/embedding/PT_HPA_CELLFM_Dev_NH8
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa_cellfm_split/PT_HPA_CELLFM_Dev_NH8_no_mae_R3/checkpoint-50000/pytorch_model.bin
# [ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa_cellfm_split/PT_HPA_CELLFM_Dev_NH8_S1_R2/checkpoint-50000/pytorch_model.bin

# Evaluation
[ -z "${num_steps}" ] && num_steps=100


python cell_fm/tasks/cell_fm/embed_hpa.py \
