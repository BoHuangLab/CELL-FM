...
[ -z "${output_dir}" ] && output_dir=./output/opencell/FT_OC_CELLFM_Crop256_S2_R1_all
...
[ -z "${loadcheck_path}" ] && loadcheck_path=finetune_opencell/FT_OC_CELLFM_S2_R2_wd1_all/checkpoint-35000

# Evaluation
[ -z "${num_steps}" ] && num_steps=100


python cell_fm/tasks/cell_fm/generate_img_opencell.py \
