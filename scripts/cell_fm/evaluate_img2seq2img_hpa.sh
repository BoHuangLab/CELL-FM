...
# Wandb
[ -z "${output_dir}" ] && output_dir=./output/hpa/img2seq2img/PT_CELL-Diff-LD_CELL-E2-split
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa/PT_CELL-Diff-V4_R7-5_BOC320-1280_MNAH8_NHL8_DPS1_ZM0d5/checkpoint-41000
# [ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_hpa/PT_CELL-Diff-V4_R9-9_BOC320-1280_MNAH8_NHL8_DPS1_ZM0d5_ALL/checkpoint-50000
...
python cell_fm/tasks/cell_fm/img2seq2img_hpa.py \
