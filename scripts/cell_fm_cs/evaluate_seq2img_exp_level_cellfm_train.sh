...
[ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_cellfm_train/
...
python cell_fm/tasks/cell_fm_cs/generate_img_exp_level_cont_cellfm_train.py \
