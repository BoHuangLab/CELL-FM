...
# Wandb
export WANDB_RUN_NAME=PT_CondenSeq_CELLFM_Dev_GFP_e_4_ignl_4_S1_ReR1
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_condenseq/PT_CondenSeq_CELLFM_GFP_S1_R1/checkpoint-42000
