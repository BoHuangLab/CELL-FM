...
# [ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_charged_domain_mutation_selected_test_data/
# [ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_charged_domain_mutation_selected_test_v6_data/
# [ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_charged_domain_mutation_random_KRDE_v2/
# [ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_charged_domain_mutation_random_KRDE_panel_v2_selected/
[ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_charged_domain_mutation_random_KRDE_panel_v2_selected_4096_512/
...
python cell_fm/tasks/cell_fm_cs/generate_img_exp_level_cont_charged_domain_mutation.py \
