...
[ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_blind_screening_hp_idr_max_il4096/
...
python cell_fm/tasks/cell_fm_cs/generate_img_exp_level_cont_blind_screening_hp_idr.py \
