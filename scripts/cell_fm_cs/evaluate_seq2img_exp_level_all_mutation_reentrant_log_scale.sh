...
[ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_all_mutation_reentrant_log_scale/
...
python cell_fm/tasks/cell_fm_cs/generate_img_exp_level_cont_mutation_reentrant_log_scale.py \
