...
# Wandb
export WANDB_RUN_NAME=PT_CondenSeq_CELLFM_SNAP_S1_R1
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_condenseq/PT_CondenSeq_CELLFM_SNAP_S1_R1/checkpoint-42000
