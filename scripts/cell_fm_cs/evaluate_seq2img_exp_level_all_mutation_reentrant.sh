...
[ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_all_mutation_reentrant/

# Dataset
[ -z "${data_path}" ] && data_path=/hpc/reference/opencell/condenseq
# [ -z "${split_key}" ] && split_key=cellfm_train_selected_balanced_for_reentrant
# [ -z "${split_key}" ] && split_key=cellfm_test_selected_balanced
[ -z "${split_key}" ] && split_key=cellfm_test_selected_uniformity_50_seq
...
python cell_fm/tasks/cell_fm_cs/generate_img_exp_level_cont_mutation_reentrant.py \
