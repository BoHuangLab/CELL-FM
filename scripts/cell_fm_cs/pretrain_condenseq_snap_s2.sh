...
# Wandb
export WANDB_RUN_NAME=PT_CondenSeq_CELLFM_SNAP_S2_R1
export WANDB_PROJECT=CELL-Diff2
[ -z "${output_dir}" ] && output_dir=pretrain_condenseq/$WANDB_RUN_NAME
# [ -z "${output_dir}" ] && output_dir='./PT_Test/PT_CondenSeq_CELLFM_SNAP_S1_R1'
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_condenseq/PT_CondenSeq_CELLFM_SNAP_S1_R1/checkpoint-100000
