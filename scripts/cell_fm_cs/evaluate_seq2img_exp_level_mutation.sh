...
[ -z "${output_dir}" ] && output_dir=/hpc/reference/opencell/condenseq/seq2img_exp_level_mutation/PT_CondenSeq_CELLFM_Dev_GFP_e_4_ignl_4_ignah_8_S1_R1_50k/
...
python cell_fm/tasks/cell_fm_cs/generate_img_exp_level_cont_mutation.py \
