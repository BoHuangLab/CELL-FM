...
# Wandb
export WANDB_RUN_NAME=PT_CondenSeq_CELLFM_Dev_GFP_S2_R1
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_condenseq_cellfm_split/PT_CondenSeq_CELLFM_Dev_GFP_S1_R1/checkpoint-100000/pytorch_model.bin
...
[ -z "${dataloader_num_workers}" ] && dataloader_num_workers=16
