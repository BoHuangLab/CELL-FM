...
# Wandb
export WANDB_RUN_NAME=PT_CondenSeq_CELLFM_Dev_GFP_e_4_ignl_4_ignah_8_sc0d1_S1_R1
export WANDB_PROJECT=CELL-Diff2
[ -z "${output_dir}" ] && output_dir=pretrain_condenseq_all/$WANDB_RUN_NAME
...
# Loss
[ -z "${seq_loss_coeff}" ] && seq_loss_coeff=0.1
...
[ -z "${num_train_epochs}" ] && num_train_epochs=500000000
...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=29182
