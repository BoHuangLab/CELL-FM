...
# Wandb
export WANDB_RUN_NAME=PT_CondenSeq_CELLFM_Dev_GFP_e_4_ignl_4_ignah_8_sc1_ic1_rc1_S2_R1
...
[ -z "${loadcheck_path}" ] && loadcheck_path=pretrain_condenseq_cellfm_split/PT_CondenSeq_CELLFM_Dev_GFP_e_4_ignl_4_ignah_8_sc0d1_ic1_rc1_S1_R1/checkpoint-10000/pytorch_model.bin
[ -z "${learning_rate}" ] && learning_rate=3e-4
[ -z "${weight_decay}" ] && weight_decay=0.0
[ -z "${gradient_accumulation_steps}" ] && gradient_accumulation_steps=1
[ -z "${per_device_train_batch_size}" ] && per_device_train_batch_size=512
...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=21292
