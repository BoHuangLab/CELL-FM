...
[ -z "${output_dir}" ] && output_dir='./output/opencell/FT_VAE_OC_256_KL1e-4_FP32'
...
# Training
[ -z "${vae_loadcheck_path}" ] && vae_loadcheck_path=finetune_opencell/FT_VAE_OC_256_KL1e-4_FP32_unclip/checkpoint-50000/pytorch_model.bin
...
python cell_fm/tasks/vae/evaluate_vae_recon_opencell.py \
