...
# Wandb
export WANDB_RUN_NAME=FT_VAE_OC_Cytoself_128_KL1e-4_FP32
...
# Training
[ -z "${vae_loadcheck_path}" ] && vae_loadcheck_path=finetune_opencell/FT_VAE_OC_Crop256_KL1e-4_FP32/checkpoint-50000/pytorch_model.bin
...
python -m torch.distributed.run $DISTRIBUTED_ARGS cell_fm/tasks/vae/finetune_vae_opencell_cytoself.py \
