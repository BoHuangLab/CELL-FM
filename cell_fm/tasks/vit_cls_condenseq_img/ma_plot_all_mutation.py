...
def main():
    # data_paths = glob('/hpc/reference/opencell/condenseq/seq2img_all_mutation_reentrant/cellfm_train_selected_balanced_for_reentrant/*/*/')
    data_paths = glob('/hpc/reference/opencell/condenseq/seq2img_all_mutation_reentrant/cellfm_test_selected_balanced/*/*/')

    # 更快的遍历方式：itertuples
    tasks = sorted(data_paths)
    ...
    with ProcessPoolExecutor(max_workers=max_workers) as ex:
        futures = [
            ex.submit(process_one_protein, data_path, 64)
