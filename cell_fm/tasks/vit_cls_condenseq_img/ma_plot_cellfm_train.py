...
def main():
    meta_path = "/hpc/reference/opencell/condenseq/cellfm_train_meta_data_large_pool_updated.csv"
    base_root = "/hpc/reference/opencell/condenseq/seq2img_cellfm_train"
    out_csv = "cellfm_train_max_gaps.csv"

    meta_data = pd.read_csv(meta_path)

    # 更快的遍历方式：itertuples
    tasks = [(int(r.index), r.protein_seq) for r in meta_data.itertuples(index=False)]
